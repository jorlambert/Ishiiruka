...
```
1. Move Brawl into FasterProjectPlus/bin/Games directory
1. Open Dolphin
2. Go to Config -> Paths -> Add
3. Add Launcher & Games directories that are in the FasterProjectPlus directory
5. Close config
6. Right click brawl and set as default iso
7. Run the game by opening the .elf file in dolphin
